...
FILES=(
  ...
  "scripts/pricing_xlsx.py"
  "kicad_ci/__init__.py"
  "kicad_ci/sexpr.py"
  "kicad_ci/api_cache.py"
  "kicad_ci/distributors/__init__.py"
  "kicad_ci/distributors/_registry.py"
  "kicad_ci/distributors/base.py"
  "kicad_ci/distributors/digikey.py"
  "kicad_ci/distributors/mouser.py"
  "kicad_ci/distributors/nexar.py"
  "kicad_ci/distributors/jlcpcb.py"
