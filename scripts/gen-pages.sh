...
#
# Inspired by the HTML navigation output of:
#   nguyen-v/KDT_Hierarchical_KiBot (MIT)
...
<div class="site-footer">
  ...
  &middot; Inspired by <a href="https://github.com/nguyen-v/KDT_Hierarchical_KiBot">KDT</a>
